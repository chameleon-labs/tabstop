...
const weightOf = (impact: Impact | null): number =>
  impact === null ? UNKNOWN_IMPACT_WEIGHT : WEIGHTS[impact]
 ...
 */
const severityRank = (impact: Impact | null): number =>
  impact === null ? -1 : WEIGHTS[impact]
