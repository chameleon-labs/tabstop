...
import {LogoutController, type LogoutRequest} from '../../../../presentation/controllers/logout/logout-controller.js';
import {MeController, type MeRequest} from '../../../../presentation/controllers/me/me-controller.js';
...
import {makeAddAccount, makeAuthenticate, makeRevokeSession} from '../../usecases/account/account-usecase-factories.js';
...
export const makeMeController = (): Controller<MeRequest> => new MeController();
