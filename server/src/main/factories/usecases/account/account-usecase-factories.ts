...
const makeStartSession = (): StartSession => new DbStartSession(
  new SessionIdAdapter(),
  new PostgresSessionRepository(getDatabase()),
  env.sessionTtlDays
)

export const makeAddAccount = (): AddAccount => new DbAddAccount(
  makeScryptAdapter(),
  new PostgresAccountRepository(getDatabase()),
  makeStartSession()
)
...
export const makeRevokeSession = (): RevokeSession =>
  new DbRevokeSession(new PostgresSessionRepository(getDatabase()))
