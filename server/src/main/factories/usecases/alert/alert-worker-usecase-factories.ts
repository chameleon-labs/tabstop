...
export const alertDispatchMode = (
  mailDriver: typeof env.mailDriver
): AlertDispatchMode => mailDriver === 'console' ? 'preview' : 'delivery'

export const makeDispatchPendingAlertEmails = (
  queue: PayloadQueue<AlertQueuePayload>
): DispatchPendingAlertEmails =>
