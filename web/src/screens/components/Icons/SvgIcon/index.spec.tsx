...
describe('SvgIcon', () => {
  it('is the only svg in the set, and every icon renders through it', () => {
    const svg = svgOf(<SvgIcon><path d="M0 0h24" /></SvgIcon>)
  ...
  it('hides itself from assistive technology', () => {
    ...
    expect(svgOf(<SvgIcon><path d="M0 0h24" /></SvgIcon>))
      .toHaveAttribute('aria-hidden', 'true')
  })

  describe('the size scale', () => {
    it('defaults to the step that matches UI text', () => {
      expect(svgOf(<SvgIcon><path d="M0 0h24" /></SvgIcon>)).toHaveClass('icon', 'icon--md')
    })

    it('names each step rather than numbering it', () => {
      expect(svgOf(<SvgIcon size="sm"><path d="M0 0h24" /></SvgIcon>)).toHaveClass('icon--sm')
      expect(svgOf(<SvgIcon size="lg"><path d="M0 0h24" /></SvgIcon>)).toHaveClass('icon--lg')
    })
    ...
    it('carries no width or height of its own, so the scale cannot be bypassed', () => {
      ...
      const svg = svgOf(<SvgIcon size="lg"><path d="M0 0h24" /></SvgIcon>)
    ...
    it('keeps a caller class alongside the scale rather than instead of it', () => {
      ...
      const svg = svgOf(
        <SvgIcon size="sm" className="landing-page__bool-check"><path d="M0 0h24" /></SvgIcon>
      )
